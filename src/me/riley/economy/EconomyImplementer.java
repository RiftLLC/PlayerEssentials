...
public class EconomyImplementer implements Economy {
    ...
    public boolean has(String s, double v) {
        Player player = Bukkit.getPlayer(s);
        return plugin.playerBank.get(player.getUniqueId()) >= v;
    }

    @Override
    public boolean has(OfflinePlayer offlinePlayer, double v) {
        return plugin.playerBank.get(offlinePlayer.getUniqueId()) >= v;
    }
    ...
    public EconomyResponse withdrawPlayer(String s, double v) {
        ...
        new PlayerManager().setBalance(player, oldBalance + v);
        return null;
    }
    ...
    public EconomyResponse withdrawPlayer(OfflinePlayer offlinePlayer, double v) {
        ...
        double oldBalance = plugin.playerBank.get(uuid);
        plugin.playerBank.put(uuid, oldBalance - v);
        new PlayerManager().setBalance(offlinePlayer, oldBalance + v);
        return null;
    }
